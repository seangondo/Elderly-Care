...
public class EditElderActivity extends AppCompatActivity {
    ...
    TextInputEditText name, birthday, house_id, robot_id, watch_id;
    ImageButton elderImage;
    Button btnBack, btnSubmit, btnDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (TextInputEditText) findViewById(R.id.elderEditName);
...
//        int day = cal.get(Calendar.DAY_OF_MONTH);
    ...
    private void submitElderEdit() {
        ...
        RequestBody elder_name = RequestBody.create(MediaType.parse("multipart/form-data"), String.valueOf(name.getText()));
        ...
        if(body != null) {
            Call<ResponseBody> call = retrofitAPI.updateElderImage(id, elder_name, birthday, houseid, robotid, watchid, body);
            ...
            Call<ResponseBody> call = retrofitAPI.updateElder(id, elder_name, birthday, houseid, robotid, watchid);
            call.enqueue(new Callback<ResponseBody>() {
                @Override
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    Toast.makeText(EditElderActivity.this, "Edit success!", Toast.LENGTH_LONG).show();
